...
var processAuthorisations = function (config, intent, msg, senderToClient, senderToDao){
   ...
   if(intent.action === 'GENERIC_CREATE')
   {
      ...
      var verified_secret  = scrypt.verify(new Buffer(msg.body[1].response.secret,   'base64'), intent.data.secret);

      console.log(verified_user, verified_secret)
      ...
      if(verified_user && verified_secret)
      {
         ...
         var t = {
            ...
            "client_id"        : msg.body[1].response.name,
